...
var PRELOAD_FAIL = _constants2.default.PRELOAD_FAIL;
    ...
    function PreloadLink() {
        ...
        _this.prepareNavigation = function () {
            ...
            toLoad.then(function (result) {
                ...
                if (preloadFailed) {
                    _this.update(_constants2.default.ON_FAIL);
                    _this.setLoaded();
                } else {
                    _this.update(_constants2.default.ON_SUCCESS);
                    _this.setLoaded(function () {
        ...
        _this.handleClick = function (e) {
            ...
            if (!_this.props.load) {
                ...
                _this.update(_constants2.default.ON_LOADING);
...
PreloadLink.init = function (options) {
    PreloadLink[_constants2.default.ON_LOADING] = options.onLoading;
    PreloadLink[_constants2.default.ON_SUCCESS] = options.onSuccess;
    PreloadLink[_constants2.default.ON_FAIL] = options.onFail;
};
